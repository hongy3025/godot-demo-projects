...
这是一个 OpenXR 项目的演示，其中玩家移动使用 XROrigin3D 作为基础节点处理。
这基于[房间规模手册页面中解释的原点中心解决方案](https://docs.godotengine.org/en/stable/tutorials/xr/xr_room_scale.html#origin-centric-solution)。

语言：GDScript

渲染器：Compatibility

在资源库中查看此演示：https://godotengine.org/asset-library/asset/2810
...
此演示实现了玩家移动问题的原点主体中心解决方案。
这是一种较旧的 XR 移动设置方法，将原点更清晰地映射在虚拟世界中。
使用此设置，更容易看到元素如何被追踪以及身体如何在追踪环境中移动。
然而，通过控制器输入移动玩家需要更多的数学计算，因为我们需要移动原点来驱动玩家移动。
...
![截图](screenshots/origin_movement_demo.png)
